...
export default function Sidebar() {
  ...
  return (
    <aside className={`bg-[#0a3a33] border-r border-[#072a25] flex flex-col justify-between min-h-screen p-4 text-slate-100 select-none transition-all duration-300 relative ${isCollapsed ? 'w-20' : 'w-64'}`}>
      <div>
        {/* Topo com Logo */}
        ...
        {/* Botão Cirúrgico de Alternância (Apenas o Ícone Limpo) */}
